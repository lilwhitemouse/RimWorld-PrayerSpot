...
namespace LWM.PrayerSpot
{
    ...
    {
        public static void GiveRelaxAloneThought(JobDriver driver)
        {
...
/*        }
        ...
        */
            ...
            if (pawn.Dead)
            {
                return; // trying to cover the bases
            }
            ...
            {
                pawn.needs.mood.thoughts.memories.TryGainMemory(ThoughtMaker.MakeThought(Defs.LWM_PrayedInChapel,
                    scoreStageIndex));
            }
